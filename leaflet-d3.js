...
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(require("d3"), require("d3-hexbin"), require("leaflet"))
    : typeof define === "function" && define.amd
    ? define(["d3", "d3-hexbin", "leaflet"], factory)
    : ((global =
        typeof globalThis !== "undefined" ? globalThis : global || self),
      factory(global.d3, global.d3.hexbin));
})(this, function (d3, d3Hexbin) {
  "use strict";
   ...
   */
  var d3_hexbin =
    null != d3__namespace.hexbin
      ? d3__namespace.hexbin
      : null != d3Hexbin__namespace
      ? d3Hexbin__namespace.hexbin
      : null;
  ...
  L.HexbinLayer = L.SVG.extend({
    ...
    initialize: function (options) {
      ...
      this._scale.color.range(this.options.colorRange).clamp(true);
    ...
    _createHexagons: function (g, data) {
      ...
      var colorExtent = that._getExtent(
        bins,
        that._fn.colorValue,
        that.options.colorScaleExtent
      );
      var radiusExtent = that._getExtent(
        bins,
        that._fn.radiusValue,
        that.options.radiusScaleExtent
      );
      ...
      if (null == colorDomain) {
        colorDomain = that._linearlySpace(
          colorExtent[0],
          colorExtent[1],
      ...
      var join = g.selectAll("g.hexbin-container").data(bins, function (d) {
        return d.x + ":" + d.y;
      });
      ...
      join
        ...
        .attr("d", function (d) {
          return that._hexLayout.hexagon(
            that._scale.radius(that._fn.radiusValue.call(that, d))
          );
        });
      ...
      // Grid enter-update
      gridEnter
        .merge(join.select("path.hexbin-grid"))
  ...
  L.HexbinHoverHandler = {
    ...
    resizeFill: function () {
      ...
      return {
        mouseover: function (hexLayer, event, data) {
          ...
          o.select("path.hexbin-hexagon").attr("d", function (d) {
        ...
        mouseout: function (hexLayer, event, data) {
          var o = d3__namespace.select(this.parentNode);
          o.select("path.hexbin-hexagon").attr("d", function (d) {
            return hexLayer._hexLayout.hexagon(
              hexLayer._scale.radius(hexLayer._fn.radiusValue.call(hexLayer, d))
            );
          });
        },
      };
    ...
    resizeScale: function (options) {
      ...
      return {
        mouseover: function (hexLayer, event, data) {
          ...
          o.select("path.hexbin-hexagon").attr("d", function (d) {
            return hexLayer._hexLayout.hexagon(
              hexLayer._scale.radius.range()[1] * (1 + options.radiusScale)
            );
          });
        },
        mouseout: function (hexLayer, event, data) {
    ...
    compound: function (options) {
      options = options || {};
      if (null == options.handlers)
        options.handlers = [L.HexbinHoverHandler.none()];
  ...
  L.PingLayer = L.SVG.extend({
    ...
    _addPing: function (data, cssClass) {
      ...
      circle.c = this._d3Container
        ...
        .attr(
          "r",
          this._fn.radiusScaleFactor.call(this, data) *
            this._scale.radius.range()[0]
        );
        ...
        if (this.options.duration < age) {
          ...
          if (immediate || d.nts < nowTs) {
            ...
            d.c
              ...
              .attr(
                "r",
                this._fn.radiusScaleFactor.call(this, d.data) *
                  this._scale.radius(age)
              )
    ...
    opacityRange: function (v) {
      if (!arguments.length) {
        return this.options.opacityRange;
      }
    ...
    radiusScaleFactor: function (v) {
      if (!arguments.length) {
        return this._fn.radiusScaleFactor;
      }
    ...
    ping: function (data, cssClass) {
      ...
      if (!this._running && this._data.length > 0) {
        ...
        var that = this;
        d3__namespace.timer(function () {
          that._updatePings.call(that, false);
        });
      }
